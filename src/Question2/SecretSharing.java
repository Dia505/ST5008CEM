...
public class SecretSharing { // Define the Solution class
    public static void main(String[] args) { // Start of the main method, entry point of the Java program
        SecretSharing obj = new SecretSharing(); // Create an instance of the Solution class
        ...
        List<Integer> result = obj.findAllPeople(n, meetings, firstPerson); // Call the method to find all people who know the secret
